...
from openapi_client.models.damage_type import DamageType  # noqa: E501
from openapi_client.rest import ApiException

class TestDamageType(unittest.TestCase):
    """DamageType unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `DamageType`
        """
        model = openapi_client.models.damage_type.DamageType()  # noqa: E501
        if include_optional :
            return DamageType(
                index = '', 
                name = '', 
