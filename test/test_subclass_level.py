...
from openapi_client.models.subclass_level import SubclassLevel  # noqa: E501
from openapi_client.rest import ApiException

class TestSubclassLevel(unittest.TestCase):
    """SubclassLevel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `SubclassLevel`
        """
        model = openapi_client.models.subclass_level.SubclassLevel()  # noqa: E501
        if include_optional :
            return SubclassLevel(
                ...
                spellcasting = openapi_client.models.subclass_level_spellcasting.SubclassLevel_spellcasting(
                    ...
                    spell_slots_level_2 = 1.337, 
                    spell_slots_level_3 = 1.337, 
                    spell_slots_level_4 = 1.337, 
                    spell_slots_level_5 = 1.337, 
                    spell_slots_level_6 = 1.337, 
                    spell_slots_level_7 = 1.337, 
                    spell_slots_level_8 = 1.337, 
                    spell_slots_level_9 = 1.337, ), 
                classspecific = {
                    'key' : null
                    }
            )
