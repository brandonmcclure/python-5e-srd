...
class TestEquipmentApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = openapi_client.api.equipment_api.EquipmentApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_api_equipment_categories_index_get(self):
        """Test case for api_equipment_categories_index_get

        Get an equipment category by index.  # noqa: E501
        """
        pass

    def test_api_equipment_index_get(self):
        """Test case for api_equipment_index_get

        Get an equipment item by index.  # noqa: E501
        """
        pass

    def test_api_magic_items_index_get(self):
        """Test case for api_magic_items_index_get

        Get a magic item by index.  # noqa: E501
        """
        pass

    def test_api_weapon_properties_index_get(self):
        """Test case for api_weapon_properties_index_get
