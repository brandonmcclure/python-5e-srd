...
class TestSubclassesApi(unittest.TestCase):
    ...
    def test_api_subclasses_index_features_get(self):
        """Test case for api_subclasses_index_features_get

        Get features available for a subclass.  # noqa: E501
        """
        pass

    def test_api_subclasses_index_get(self):
        """Test case for api_subclasses_index_get

        Get a subclass by index.  # noqa: E501
        """
        pass

    def test_api_subclasses_index_levels_get(self):
        """Test case for api_subclasses_index_levels_get

        Get all level resources for a subclass.  # noqa: E501
        """
        pass

    def test_api_subclasses_index_levels_subclass_level_features_get(self):
        """Test case for api_subclasses_index_levels_subclass_level_features_get

        Get features of the requested spell level available to the class.  # noqa: E501
        """
        pass

    def test_api_subclasses_index_levels_subclass_level_get(self):
        """Test case for api_subclasses_index_levels_subclass_level_get
