...
class TestClassLevelsApi(unittest.TestCase):
    ...
    def test_api_classes_index_levels_class_level_features_get(self):
        """Test case for api_classes_index_levels_class_level_features_get

        Get features available to a class at the requested level.  # noqa: E501
        """
        pass

    def test_api_classes_index_levels_class_level_get(self):
        """Test case for api_classes_index_levels_class_level_get

        Get level resource for a class and level.  # noqa: E501
        """
        pass

    def test_api_classes_index_levels_get(self):
        """Test case for api_classes_index_levels_get

        Get all level resources for a class.  # noqa: E501
        """
        pass

    def test_api_classes_index_levels_spell_level_spells_get(self):
        """Test case for api_classes_index_levels_spell_level_spells_get
