...
class TestClassLevelClassSpecific(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return ClassLevelClassSpecific(
                rage_count = 1.337, 
                rage_damage_bonus = 1.337, 
                brutal_critical_dice = 1.337, 
                bardic_inspiration_dice = 1.337, 
                song_of_rest_die = 1.337, 
                magical_secrets_max_5 = 1.337, 
                magical_secrets_max_7 = 1.337, 
                magical_secrets_max_9 = 1.337, 
                channel_divinity_charges = 1.337, 
                destroy_undead_cr = 1.337, 
                wild_shape_max_cr = 1.337, 
                wild_shape_swim = True, 
                wild_shape_fly = True, 
                action_surges = 1.337, 
                indomitable_uses = 1.337, 
                extra_attacks = 1.337, 
                ki_points = 1.337, 
                ...
                invocations_known = 1.337, 
                mystic_arcanum_level_6 = 1.337, 
                mystic_arcanum_level_7 = 1.337, 
                mystic_arcanum_level_8 = 1.337, 
                mystic_arcanum_level_9 = 1.337, 
    ...
    def testClassLevelClassSpecific(self):
        """Test ClassLevelClassSpecific"""
