...
from openapi_client.models.magic_school import MagicSchool  # noqa: E501
from openapi_client.rest import ApiException

class TestMagicSchool(unittest.TestCase):
    """MagicSchool unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `MagicSchool`
        """
        model = openapi_client.models.magic_school.MagicSchool()  # noqa: E501
        if include_optional :
            return MagicSchool(
                index = '', 
                name = '', 
