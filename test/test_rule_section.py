...
from openapi_client.models.rule_section import RuleSection  # noqa: E501
from openapi_client.rest import ApiException

class TestRuleSection(unittest.TestCase):
    """RuleSection unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `RuleSection`
        """
        model = openapi_client.models.rule_section.RuleSection()  # noqa: E501
        if include_optional :
            return RuleSection(
                index = '', 
                name = '', 
