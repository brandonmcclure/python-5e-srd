...
from openapi_client.models.trait_all_of_trait_specific_one_of import TraitAllOfTraitSpecificOneOf  # noqa: E501
from openapi_client.rest import ApiException

class TestTraitAllOfTraitSpecificOneOf(unittest.TestCase):
    """TraitAllOfTraitSpecificOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TraitAllOfTraitSpecificOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TraitAllOfTraitSpecificOneOf`
        """
        model = openapi_client.models.trait_all_of_trait_specific_one_of.TraitAllOfTraitSpecificOneOf()  # noqa: E501
        if include_optional :
            return TraitAllOfTraitSpecificOneOf(
                damage_type = openapi_client.models.api_reference.APIReference(
                    index = '', 
                    name = '', 
                    url = '', ), 
                breath_weapon = openapi_client.models.trait_all_of_trait_specific_one_of_breath_weapon.Trait_allOf_trait_specific_oneOf_breath_weapon(
                    name = '', 
                    desc = '', 
    ...
    def testTraitAllOfTraitSpecificOneOf(self):
        """Test TraitAllOfTraitSpecificOneOf"""
