...
from openapi_client.models.monster_all_of_speed import MonsterAllOfSpeed  # noqa: E501
from openapi_client.rest import ApiException

class TestMonsterAllOfSpeed(unittest.TestCase):
    """MonsterAllOfSpeed unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MonsterAllOfSpeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonsterAllOfSpeed`
        """
        model = openapi_client.models.monster_all_of_speed.MonsterAllOfSpeed()  # noqa: E501
        if include_optional :
            return MonsterAllOfSpeed(
                walk = '', 
                burrow = '', 
                climb = '', 
                fly = '', 
    ...
    def testMonsterAllOfSpeed(self):
        """Test MonsterAllOfSpeed"""
