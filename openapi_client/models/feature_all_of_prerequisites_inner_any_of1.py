...
class FeatureAllOfPrerequisitesInnerAnyOf1(BaseModel):
    """
    FeatureAllOfPrerequisitesInnerAnyOf1
    """
    type: Optional[StrictStr] = None
    feature: Optional[StrictStr] = None
    __properties = ["type", "feature"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeatureAllOfPrerequisitesInnerAnyOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeatureAllOfPrerequisitesInnerAnyOf1:
        """Create an instance of FeatureAllOfPrerequisitesInnerAnyOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeatureAllOfPrerequisitesInnerAnyOf1.parse_obj(obj)

        _obj = FeatureAllOfPrerequisitesInnerAnyOf1.parse_obj({
            "type": obj.get("type"),
