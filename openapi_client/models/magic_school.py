...
class MagicSchool(BaseModel):
    ...
    __properties = ["index", "name", "url", "desc"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MagicSchool:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MagicSchool:
        """Create an instance of MagicSchool from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MagicSchool.parse_obj(obj)

        _obj = MagicSchool.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "desc": obj.get("desc")
