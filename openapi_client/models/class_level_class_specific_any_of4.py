...
class ClassLevelClassSpecificAnyOf4(BaseModel):
    """
    Fighter Class Specific Features
    """
    action_surges: Optional[Union[StrictFloat, StrictInt]] = None
    indomitable_uses: Optional[Union[StrictFloat, StrictInt]] = None
    extra_attacks: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["action_surges", "indomitable_uses", "extra_attacks"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf4:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf4:
        """Create an instance of ClassLevelClassSpecificAnyOf4 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf4.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf4.parse_obj({
            "action_surges": obj.get("action_surges"),
            "indomitable_uses": obj.get("indomitable_uses"),
            "extra_attacks": obj.get("extra_attacks")
        })
        return _obj
