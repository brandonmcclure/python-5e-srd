...
class MonsterAction(BaseModel):
    ...
    action_options: Optional[Choice] = None
    actions: Optional[conlist(MonsterMultiAttackAction)] = None
    options: Optional[Choice] = None
    multiattack_type: Optional[StrictStr] = None
    attack_bonus: Optional[Union[StrictFloat, StrictInt]] = None
    dc: Optional[DC] = None
    attacks: Optional[conlist(MonsterAttack)] = None
    damage: Optional[conlist(Damage)] = None
    __properties = ["name", "desc", "action_options", "actions", "options", "multiattack_type", "attack_bonus", "dc", "attacks", "damage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterAction:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of action_options
        if self.action_options:
            _dict['action_options'] = self.action_options.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in damage (list)
        _items = []
        if self.damage:
            for _item in self.damage:
                if _item:
                    _items.append(_item.to_dict())
            _dict['damage'] = _items
        return _dict
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterAction:
        """Create an instance of MonsterAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterAction.parse_obj(obj)

        _obj = MonsterAction.parse_obj({
            "name": obj.get("name"),
            "desc": obj.get("desc"),
            "action_options": Choice.from_dict(obj.get("action_options")) if obj.get("action_options") is not None else None,
            "actions": [MonsterMultiAttackAction.from_dict(_item) for _item in obj.get("actions")] if obj.get("actions") is not None else None,
            "options": Choice.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "multiattack_type": obj.get("multiattack_type"),
            "attack_bonus": obj.get("attack_bonus"),
            "dc": DC.from_dict(obj.get("dc")) if obj.get("dc") is not None else None,
            "attacks": [MonsterAttack.from_dict(_item) for _item in obj.get("attacks")] if obj.get("attacks") is not None else None,
            "damage": [Damage.from_dict(_item) for _item in obj.get("damage")] if obj.get("damage") is not None else None
        })
        return _obj
