...
class FeatureAllOfPrerequisitesInnerAnyOf2(BaseModel):
    """
    FeatureAllOfPrerequisitesInnerAnyOf2
    """
    type: Optional[StrictStr] = None
    spell: Optional[StrictStr] = None
    __properties = ["type", "spell"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeatureAllOfPrerequisitesInnerAnyOf2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeatureAllOfPrerequisitesInnerAnyOf2:
        """Create an instance of FeatureAllOfPrerequisitesInnerAnyOf2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeatureAllOfPrerequisitesInnerAnyOf2.parse_obj(obj)

        _obj = FeatureAllOfPrerequisitesInnerAnyOf2.parse_obj({
            "type": obj.get("type"),
            "spell": obj.get("spell")
        })
        return _obj
