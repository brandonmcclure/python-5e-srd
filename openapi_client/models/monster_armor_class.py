...
class MonsterArmorClass(BaseModel):
    ...
    """
    # data type: MonsterArmorClassOneOf
    oneof_schema_1_validator: Optional[MonsterArmorClassOneOf] = None
    # data type: MonsterArmorClassOneOf1
    oneof_schema_2_validator: Optional[MonsterArmorClassOneOf1] = None
    # data type: MonsterArmorClassOneOf2
    oneof_schema_3_validator: Optional[MonsterArmorClassOneOf2] = None
    # data type: MonsterArmorClassOneOf3
    oneof_schema_4_validator: Optional[MonsterArmorClassOneOf3] = None
    # data type: MonsterArmorClassOneOf4
    oneof_schema_5_validator: Optional[MonsterArmorClassOneOf4] = None
    if TYPE_CHECKING:
        actual_instance: Union[MonsterArmorClassOneOf, MonsterArmorClassOneOf1, MonsterArmorClassOneOf2, MonsterArmorClassOneOf3, MonsterArmorClassOneOf4]
    else:
        actual_instance: Any
    one_of_schemas: List[str] = Field(MONSTERARMORCLASS_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = MonsterArmorClass.construct()
        error_messages = []
        match = 0
        # validate data type: MonsterArmorClassOneOf
        if not isinstance(v, MonsterArmorClassOneOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MonsterArmorClassOneOf`")
        else:
            match += 1
        # validate data type: MonsterArmorClassOneOf1
        if not isinstance(v, MonsterArmorClassOneOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MonsterArmorClassOneOf1`")
        else:
            match += 1
        # validate data type: MonsterArmorClassOneOf2
        if not isinstance(v, MonsterArmorClassOneOf2):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MonsterArmorClassOneOf2`")
        else:
            match += 1
        # validate data type: MonsterArmorClassOneOf3
        if not isinstance(v, MonsterArmorClassOneOf3):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MonsterArmorClassOneOf3`")
        else:
            match += 1
        # validate data type: MonsterArmorClassOneOf4
        if not isinstance(v, MonsterArmorClassOneOf4):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MonsterArmorClassOneOf4`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in MonsterArmorClass with oneOf schemas: MonsterArmorClassOneOf, MonsterArmorClassOneOf1, MonsterArmorClassOneOf2, MonsterArmorClassOneOf3, MonsterArmorClassOneOf4. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in MonsterArmorClass with oneOf schemas: MonsterArmorClassOneOf, MonsterArmorClassOneOf1, MonsterArmorClassOneOf2, MonsterArmorClassOneOf3, MonsterArmorClassOneOf4. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> MonsterArmorClass:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> MonsterArmorClass:
        """Returns the object represented by the json string"""
        instance = MonsterArmorClass.construct()
        error_messages = []
        match = 0

        # deserialize data into MonsterArmorClassOneOf
        try:
            instance.actual_instance = MonsterArmorClassOneOf.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into MonsterArmorClassOneOf1
        try:
            instance.actual_instance = MonsterArmorClassOneOf1.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into MonsterArmorClassOneOf2
        try:
            instance.actual_instance = MonsterArmorClassOneOf2.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into MonsterArmorClassOneOf3
        try:
            instance.actual_instance = MonsterArmorClassOneOf3.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into MonsterArmorClassOneOf4
        try:
            instance.actual_instance = MonsterArmorClassOneOf4.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into MonsterArmorClass with oneOf schemas: MonsterArmorClassOneOf, MonsterArmorClassOneOf1, MonsterArmorClassOneOf2, MonsterArmorClassOneOf3, MonsterArmorClassOneOf4. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into MonsterArmorClass with oneOf schemas: MonsterArmorClassOneOf, MonsterArmorClassOneOf1, MonsterArmorClassOneOf2, MonsterArmorClassOneOf3, MonsterArmorClassOneOf4. Details: " + ", ".join(error_messages))
        else:
            return instance
