...
class ClassLevelClassSpecificAnyOf11(BaseModel):
    """
    Wizard Class Specific Features
    """
    arcane_recover_levels: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["arcane_recover_levels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf11:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf11:
        """Create an instance of ClassLevelClassSpecificAnyOf11 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf11.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf11.parse_obj({
            "arcane_recover_levels": obj.get("arcane_recover_levels")
        })
        return _obj
