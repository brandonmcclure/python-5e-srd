...
class FeatureAllOfPrerequisitesInner(BaseModel):
    ...
    # data type: FeatureAllOfPrerequisitesInnerAnyOf
    anyof_schema_1_validator: Optional[FeatureAllOfPrerequisitesInnerAnyOf] = None
    # data type: FeatureAllOfPrerequisitesInnerAnyOf1
    anyof_schema_2_validator: Optional[FeatureAllOfPrerequisitesInnerAnyOf1] = None
    # data type: FeatureAllOfPrerequisitesInnerAnyOf2
    anyof_schema_3_validator: Optional[FeatureAllOfPrerequisitesInnerAnyOf2] = None
    if TYPE_CHECKING:
        actual_instance: Union[FeatureAllOfPrerequisitesInnerAnyOf, FeatureAllOfPrerequisitesInnerAnyOf1, FeatureAllOfPrerequisitesInnerAnyOf2]
    else:
        actual_instance: Any
    any_of_schemas: List[str] = Field(FEATUREALLOFPREREQUISITESINNER_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FeatureAllOfPrerequisitesInner.construct()
        error_messages = []
        # validate data type: FeatureAllOfPrerequisitesInnerAnyOf
        if not isinstance(v, FeatureAllOfPrerequisitesInnerAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FeatureAllOfPrerequisitesInnerAnyOf`")
        else:
            return v

        # validate data type: FeatureAllOfPrerequisitesInnerAnyOf1
        if not isinstance(v, FeatureAllOfPrerequisitesInnerAnyOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FeatureAllOfPrerequisitesInnerAnyOf1`")
        else:
            return v

        # validate data type: FeatureAllOfPrerequisitesInnerAnyOf2
        if not isinstance(v, FeatureAllOfPrerequisitesInnerAnyOf2):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FeatureAllOfPrerequisitesInnerAnyOf2`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FeatureAllOfPrerequisitesInner with anyOf schemas: FeatureAllOfPrerequisitesInnerAnyOf, FeatureAllOfPrerequisitesInnerAnyOf1, FeatureAllOfPrerequisitesInnerAnyOf2. Details: " + ", ".join(error_messages))
        else:
            return v

    @classmethod
    def from_dict(cls, obj: dict) -> FeatureAllOfPrerequisitesInner:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> FeatureAllOfPrerequisitesInner:
        """Returns the object represented by the json string"""
        instance = FeatureAllOfPrerequisitesInner.construct()
        error_messages = []
        # anyof_schema_1_validator: Optional[FeatureAllOfPrerequisitesInnerAnyOf] = None
        try:
            instance.actual_instance = FeatureAllOfPrerequisitesInnerAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[FeatureAllOfPrerequisitesInnerAnyOf1] = None
        try:
            instance.actual_instance = FeatureAllOfPrerequisitesInnerAnyOf1.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[FeatureAllOfPrerequisitesInnerAnyOf2] = None
        try:
            instance.actual_instance = FeatureAllOfPrerequisitesInnerAnyOf2.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FeatureAllOfPrerequisitesInner with anyOf schemas: FeatureAllOfPrerequisitesInnerAnyOf, FeatureAllOfPrerequisitesInnerAnyOf1, FeatureAllOfPrerequisitesInnerAnyOf2. Details: " + ", ".join(error_messages))
        else:
            return instance
