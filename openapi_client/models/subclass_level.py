...
class SubclassLevel(BaseModel):
    ...
    level: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Number value for the current level object.")
    ...
    features: Optional[conlist(APIReference)] = Field(None, description="List of features gained at this level.")
    spellcasting: Optional[SubclassLevelSpellcasting] = None
    classspecific: Optional[Dict[str, Any]] = Field(None, description="Class specific information such as dice values for bard songs and number of warlock invocations.")
    __properties = ["index", "url", "level", "ability_score_bonuses", "prof_bonus", "features", "spellcasting", "classspecific"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubclassLevel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubclassLevel:
        """Create an instance of SubclassLevel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubclassLevel.parse_obj(obj)

        _obj = SubclassLevel.parse_obj({
            "index": obj.get("index"),
            "url": obj.get("url"),
            "level": obj.get("level"),
            ...
            "classspecific": obj.get("classspecific")
        })
        return _obj
