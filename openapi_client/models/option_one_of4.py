...
class OptionOneOf4(BaseModel):
    """
    OptionOneOf4
    """
    option_type: Optional[StrictStr] = Field(None, description="Type of option; determines other attributes.")
    string: Optional[StrictStr] = Field(None, description="The string.")
    __properties = ["option_type", "string"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OptionOneOf4:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OptionOneOf4:
        """Create an instance of OptionOneOf4 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OptionOneOf4.parse_obj(obj)

        _obj = OptionOneOf4.parse_obj({
