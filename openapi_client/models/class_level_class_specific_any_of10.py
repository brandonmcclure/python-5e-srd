...
class ClassLevelClassSpecificAnyOf10(BaseModel):
    """
    Bard Warlock Specific Features
    """
    invocations_known: Optional[Union[StrictFloat, StrictInt]] = None
    mystic_arcanum_level_6: Optional[Union[StrictFloat, StrictInt]] = None
    mystic_arcanum_level_7: Optional[Union[StrictFloat, StrictInt]] = None
    mystic_arcanum_level_8: Optional[Union[StrictFloat, StrictInt]] = None
    mystic_arcanum_level_9: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["invocations_known", "mystic_arcanum_level_6", "mystic_arcanum_level_7", "mystic_arcanum_level_8", "mystic_arcanum_level_9"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf10:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf10:
        """Create an instance of ClassLevelClassSpecificAnyOf10 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf10.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf10.parse_obj({
            "invocations_known": obj.get("invocations_known"),
            "mystic_arcanum_level_6": obj.get("mystic_arcanum_level_6"),
            "mystic_arcanum_level_7": obj.get("mystic_arcanum_level_7"),
            "mystic_arcanum_level_8": obj.get("mystic_arcanum_level_8"),
            "mystic_arcanum_level_9": obj.get("mystic_arcanum_level_9")
        })
        return _obj
