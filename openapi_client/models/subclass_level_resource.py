...
class SubclassLevelResource(BaseModel):
    ...
    features: Optional[conlist(APIReference)] = None
    var_class: Optional[APIReference] = Field(None, alias="class")
    subclass: Optional[APIReference] = None
    __properties = ["index", "url", "level", "features", "class", "subclass"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubclassLevelResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubclassLevelResource:
        """Create an instance of SubclassLevelResource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubclassLevelResource.parse_obj(obj)

        _obj = SubclassLevelResource.parse_obj({
            "index": obj.get("index"),
            "url": obj.get("url"),
            "level": obj.get("level"),
