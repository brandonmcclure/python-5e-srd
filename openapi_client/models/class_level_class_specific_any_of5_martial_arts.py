...
class ClassLevelClassSpecificAnyOf5MartialArts(BaseModel):
    """
    ClassLevelClassSpecificAnyOf5MartialArts
    """
    dice_count: Optional[Union[StrictFloat, StrictInt]] = None
    dice_value: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["dice_count", "dice_value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf5MartialArts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf5MartialArts:
        """Create an instance of ClassLevelClassSpecificAnyOf5MartialArts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf5MartialArts.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf5MartialArts.parse_obj({
            "dice_count": obj.get("dice_count"),
            "dice_value": obj.get("dice_value")
        })
        return _obj
