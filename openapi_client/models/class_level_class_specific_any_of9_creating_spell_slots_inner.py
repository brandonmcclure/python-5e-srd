...
class ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner(BaseModel):
    """
    ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner
    """
    spell_slot_level: Optional[Union[StrictFloat, StrictInt]] = None
    sorcery_point_cost: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["spell_slot_level", "sorcery_point_cost"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner:
        """Create an instance of ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf9CreatingSpellSlotsInner.parse_obj({
            "spell_slot_level": obj.get("spell_slot_level"),
            "sorcery_point_cost": obj.get("sorcery_point_cost")
        })
        return _obj
