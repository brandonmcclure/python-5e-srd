...
class ModelClass(BaseModel):
    ...
    hit_die: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Hit die of the class. (ex: 12 == 1d12).")
    class_levels: Optional[StrictStr] = Field(None, description="URL of the level resource for the class.")
    multi_classing: Optional[Multiclassing] = None
    spellcasting: Optional[Spellcasting] = None
    spells: Optional[StrictStr] = Field(None, description="URL of the spell resource list for the class.")
    starting_equipment: Optional[conlist(ClassAllOfStartingEquipment)] = Field(None, description="List of equipment and their quantities all players of the class start with.")
    starting_equipment_options: Optional[conlist(Choice)] = Field(None, description="List of choices of starting equipment.")
    proficiency_choices: Optional[conlist(Choice)] = Field(None, description="List of choices of starting proficiencies.")
    proficiencies: Optional[conlist(APIReference)] = Field(None, description="List of starting proficiencies for all new characters of this class.")
    saving_throws: Optional[conlist(APIReference)] = Field(None, description="Saving throws the class is proficient in.")
    subclasses: Optional[conlist(APIReference)] = Field(None, description="List of all possible subclasses this class can specialize in.")
    __properties = ["index", "name", "url", "hit_die", "class_levels", "multi_classing", "spellcasting", "spells", "starting_equipment", "starting_equipment_options", "proficiency_choices", "proficiencies", "saving_throws", "subclasses"]
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of multi_classing
        if self.multi_classing:
            _dict['multi_classing'] = self.multi_classing.to_dict()
        # override the default output from pydantic by calling `to_dict()` of spellcasting
        if self.spellcasting:
            _dict['spellcasting'] = self.spellcasting.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in starting_equipment_options (list)
        _items = []
        if self.starting_equipment_options:
            for _item in self.starting_equipment_options:
                if _item:
                    _items.append(_item.to_dict())
            _dict['starting_equipment_options'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in proficiency_choices (list)
        _items = []
        if self.proficiency_choices:
            for _item in self.proficiency_choices:
                if _item:
                    _items.append(_item.to_dict())
            _dict['proficiency_choices'] = _items
        ...
        if self.saving_throws:
            for _item in self.saving_throws:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: dict) -> ModelClass:
        ...
        _obj = ModelClass.parse_obj({
            ...
            "name": obj.get("name"),
            "url": obj.get("url"),
            "hit_die": obj.get("hit_die"),
            "class_levels": obj.get("class_levels"),
            "multi_classing": Multiclassing.from_dict(obj.get("multi_classing")) if obj.get("multi_classing") is not None else None,
            "spellcasting": Spellcasting.from_dict(obj.get("spellcasting")) if obj.get("spellcasting") is not None else None,
            "spells": obj.get("spells"),
            "starting_equipment": [ClassAllOfStartingEquipment.from_dict(_item) for _item in obj.get("starting_equipment")] if obj.get("starting_equipment") is not None else None,
            "starting_equipment_options": [Choice.from_dict(_item) for _item in obj.get("starting_equipment_options")] if obj.get("starting_equipment_options") is not None else None,
            "proficiency_choices": [Choice.from_dict(_item) for _item in obj.get("proficiency_choices")] if obj.get("proficiency_choices") is not None else None,
            "proficiencies": [APIReference.from_dict(_item) for _item in obj.get("proficiencies")] if obj.get("proficiencies") is not None else None,
            "saving_throws": [APIReference.from_dict(_item) for _item in obj.get("saving_throws")] if obj.get("saving_throws") is not None else None,
            "subclasses": [APIReference.from_dict(_item) for _item in obj.get("subclasses")] if obj.get("subclasses") is not None else None
        })
        return _obj
