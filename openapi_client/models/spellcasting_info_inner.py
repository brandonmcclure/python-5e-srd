...
class SpellcastingInfoInner(BaseModel):
    """
    SpellcastingInfoInner
    """
    name: Optional[StrictStr] = Field(None, description="Feature name.")
    desc: Optional[conlist(StrictStr)] = Field(None, description="Feature description.")
    __properties = ["name", "desc"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpellcastingInfoInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpellcastingInfoInner:
        """Create an instance of SpellcastingInfoInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpellcastingInfoInner.parse_obj(obj)

        _obj = SpellcastingInfoInner.parse_obj({
            "name": obj.get("name"),
            "desc": obj.get("desc")
        })
        return _obj
