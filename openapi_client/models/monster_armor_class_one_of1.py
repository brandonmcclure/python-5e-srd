...
class MonsterArmorClassOneOf1(BaseModel):
    """
    MonsterArmorClassOneOf1
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('natural'):
            raise ValueError("must be one of enum values ('natural')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterArmorClassOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterArmorClassOneOf1:
        """Create an instance of MonsterArmorClassOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterArmorClassOneOf1.parse_obj(obj)

        _obj = MonsterArmorClassOneOf1.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
            "desc": obj.get("desc")
        })
