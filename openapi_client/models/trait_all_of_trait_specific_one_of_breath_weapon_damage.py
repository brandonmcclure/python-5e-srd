...
class TraitAllOfTraitSpecificOneOfBreathWeaponDamage(BaseModel):
    ...
    __properties = ["damage_at_character_level", "damage_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TraitAllOfTraitSpecificOneOfBreathWeaponDamage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TraitAllOfTraitSpecificOneOfBreathWeaponDamage:
        """Create an instance of TraitAllOfTraitSpecificOneOfBreathWeaponDamage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TraitAllOfTraitSpecificOneOfBreathWeaponDamage.parse_obj(obj)

        _obj = TraitAllOfTraitSpecificOneOfBreathWeaponDamage.parse_obj({
            "damage_at_character_level": obj.get("damage_at_character_level"),
