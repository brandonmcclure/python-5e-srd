...
class WeaponAllOfRange(BaseModel):
    """
    WeaponAllOfRange
    """
    normal: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The weapon's normal range in feet.")
    long: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The weapon's long range in feet.")
    __properties = ["normal", "long"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WeaponAllOfRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WeaponAllOfRange:
        """Create an instance of WeaponAllOfRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WeaponAllOfRange.parse_obj(obj)

        _obj = WeaponAllOfRange.parse_obj({
