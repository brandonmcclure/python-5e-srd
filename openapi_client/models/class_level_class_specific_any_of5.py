...
class ClassLevelClassSpecificAnyOf5(BaseModel):
    ...
    martial_arts: Optional[ClassLevelClassSpecificAnyOf5MartialArts] = None
    __properties = ["ki_points", "unarmored_movement", "martial_arts"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf5:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of martial_arts
        if self.martial_arts:
            _dict['martial_arts'] = self.martial_arts.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf5:
        """Create an instance of ClassLevelClassSpecificAnyOf5 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf5.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf5.parse_obj({
            "ki_points": obj.get("ki_points"),
            "unarmored_movement": obj.get("unarmored_movement"),
            "martial_arts": ClassLevelClassSpecificAnyOf5MartialArts.from_dict(obj.get("martial_arts")) if obj.get("martial_arts") is not None else None
        })
        return _obj
