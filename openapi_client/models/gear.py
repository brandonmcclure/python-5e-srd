...
class Gear(BaseModel):
    ...
    __properties = ["index", "name", "url", "desc", "equipment_category", "gear_category", "cost", "weight"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Gear:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Gear:
        """Create an instance of Gear from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Gear.parse_obj(obj)
