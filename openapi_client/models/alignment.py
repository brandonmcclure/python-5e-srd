...
class Alignment(BaseModel):
    ...
    desc: Optional[StrictStr] = Field(None, description="Brief description of the resource.")
    abbreviation: Optional[StrictStr] = Field(None, description="Abbreviation/initials/acronym for the alignment.")
    __properties = ["index", "name", "url", "desc", "abbreviation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Alignment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Alignment:
        """Create an instance of Alignment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Alignment.parse_obj(obj)

        _obj = Alignment.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "desc": obj.get("desc"),
