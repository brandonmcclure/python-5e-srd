...
class Prerequisite(BaseModel):
    ...
    __properties = ["ability_score", "minimum_score"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Prerequisite:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Prerequisite:
        """Create an instance of Prerequisite from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Prerequisite.parse_obj(obj)

        _obj = Prerequisite.parse_obj({
