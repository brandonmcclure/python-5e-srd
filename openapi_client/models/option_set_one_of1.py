...
class OptionSetOneOf1(BaseModel):
    ...
    __properties = ["option_set_type", "equipment_category"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OptionSetOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OptionSetOneOf1:
        """Create an instance of OptionSetOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OptionSetOneOf1.parse_obj(obj)

        _obj = OptionSetOneOf1.parse_obj({
