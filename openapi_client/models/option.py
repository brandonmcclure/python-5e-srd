...
class Option(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[OptionOneOf, OptionOneOf1, OptionOneOf10, OptionOneOf2, OptionOneOf3, OptionOneOf4, OptionOneOf5, OptionOneOf6, OptionOneOf7, OptionOneOf8, OptionOneOf9]
    else:
        actual_instance: Any
