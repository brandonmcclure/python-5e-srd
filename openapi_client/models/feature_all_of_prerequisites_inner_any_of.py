...
class FeatureAllOfPrerequisitesInnerAnyOf(BaseModel):
    """
    FeatureAllOfPrerequisitesInnerAnyOf
    """
    type: Optional[StrictStr] = None
    level: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["type", "level"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeatureAllOfPrerequisitesInnerAnyOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeatureAllOfPrerequisitesInnerAnyOf:
        """Create an instance of FeatureAllOfPrerequisitesInnerAnyOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeatureAllOfPrerequisitesInnerAnyOf.parse_obj(obj)

        _obj = FeatureAllOfPrerequisitesInnerAnyOf.parse_obj({
            "type": obj.get("type"),
            "level": obj.get("level")
        })
        return _obj
