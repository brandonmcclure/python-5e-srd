...
class ClassLevelClassSpecificAnyOf(BaseModel):
    """
    Barbarian Class Specific Features
    """
    rage_count: Optional[Union[StrictFloat, StrictInt]] = None
    rage_damage_bonus: Optional[Union[StrictFloat, StrictInt]] = None
    brutal_critical_dice: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["rage_count", "rage_damage_bonus", "brutal_critical_dice"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf:
        """Create an instance of ClassLevelClassSpecificAnyOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf.parse_obj({
            "rage_count": obj.get("rage_count"),
            "rage_damage_bonus": obj.get("rage_damage_bonus"),
            "brutal_critical_dice": obj.get("brutal_critical_dice")
        })
        return _obj
