...
class MonsterArmorClassOneOf4(BaseModel):
    ...
    condition: Optional[APIReference] = None
    desc: Optional[StrictStr] = None
    __properties = ["type", "value", "condition", "desc"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterArmorClassOneOf4:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterArmorClassOneOf4:
        """Create an instance of MonsterArmorClassOneOf4 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterArmorClassOneOf4.parse_obj(obj)

        _obj = MonsterArmorClassOneOf4.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
            "condition": APIReference.from_dict(obj.get("condition")) if obj.get("condition") is not None else None,
            "desc": obj.get("desc")
        })
        return _obj
