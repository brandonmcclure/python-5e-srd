...
class MonsterAttack(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterAttack:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterAttack:
        """Create an instance of MonsterAttack from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterAttack.parse_obj(obj)

        _obj = MonsterAttack.parse_obj({
            "name": obj.get("name"),
