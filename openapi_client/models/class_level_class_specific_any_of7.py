...
class ClassLevelClassSpecificAnyOf7(BaseModel):
    """
    Bard Ranger Specific Features
    """
    favored_enemies: Optional[Union[StrictFloat, StrictInt]] = None
    favored_terrain: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["favored_enemies", "favored_terrain"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf7:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf7:
        """Create an instance of ClassLevelClassSpecificAnyOf7 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf7.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf7.parse_obj({
            "favored_enemies": obj.get("favored_enemies"),
            "favored_terrain": obj.get("favored_terrain")
        })
        return _obj
