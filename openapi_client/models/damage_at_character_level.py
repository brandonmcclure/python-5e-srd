...
class DamageAtCharacterLevel(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DamageAtCharacterLevel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DamageAtCharacterLevel:
        """Create an instance of DamageAtCharacterLevel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DamageAtCharacterLevel.parse_obj(obj)

        _obj = DamageAtCharacterLevel.parse_obj({
