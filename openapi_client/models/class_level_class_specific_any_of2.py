...
class ClassLevelClassSpecificAnyOf2(BaseModel):
    """
    Cleric Class Specific Features
    """
    channel_divinity_charges: Optional[Union[StrictFloat, StrictInt]] = None
    destroy_undead_cr: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["channel_divinity_charges", "destroy_undead_cr"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf2:
        """Create an instance of ClassLevelClassSpecificAnyOf2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf2.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf2.parse_obj({
            "channel_divinity_charges": obj.get("channel_divinity_charges"),
            "destroy_undead_cr": obj.get("destroy_undead_cr")
        })
        return _obj
