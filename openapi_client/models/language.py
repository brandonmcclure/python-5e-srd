...
class Language(BaseModel):
    ...
    desc: Optional[StrictStr] = Field(None, description="Brief description of the language.")
    type: Optional[StrictStr] = None
    script: Optional[StrictStr] = Field(None, description="Script used for writing in the language.")
    typical_speakers: Optional[conlist(StrictStr)] = Field(None, description="List of races that tend to speak the language.")
    __properties = ["index", "name", "url", "desc", "type", "script", "typical_speakers"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Standard', 'Exotic'):
            raise ValueError("must be one of enum values ('Standard', 'Exotic')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Language:
        ...
        _obj = Language.parse_obj({
            ...
            "typical_speakers": obj.get("typical_speakers")
        })
        return _obj
