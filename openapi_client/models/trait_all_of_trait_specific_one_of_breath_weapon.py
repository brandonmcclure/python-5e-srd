...
class TraitAllOfTraitSpecificOneOfBreathWeapon(BaseModel):
    ...
    damage: Optional[TraitAllOfTraitSpecificOneOfBreathWeaponDamage] = None
    dc: Optional[DC] = None
    usage: Optional[TraitAllOfTraitSpecificOneOfBreathWeaponUsage] = None
    __properties = ["name", "desc", "area_of_effect", "damage", "dc", "usage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TraitAllOfTraitSpecificOneOfBreathWeapon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TraitAllOfTraitSpecificOneOfBreathWeapon:
        """Create an instance of TraitAllOfTraitSpecificOneOfBreathWeapon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TraitAllOfTraitSpecificOneOfBreathWeapon.parse_obj(obj)

        _obj = TraitAllOfTraitSpecificOneOfBreathWeapon.parse_obj({
            "name": obj.get("name"),
            "desc": obj.get("desc"),
            "area_of_effect": AreaOfEffect.from_dict(obj.get("area_of_effect")) if obj.get("area_of_effect") is not None else None,
            "damage": TraitAllOfTraitSpecificOneOfBreathWeaponDamage.from_dict(obj.get("damage")) if obj.get("damage") is not None else None,
            "dc": DC.from_dict(obj.get("dc")) if obj.get("dc") is not None else None,
            "usage": TraitAllOfTraitSpecificOneOfBreathWeaponUsage.from_dict(obj.get("usage")) if obj.get("usage") is not None else None
        })
        return _obj
