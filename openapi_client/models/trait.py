...
class Trait(BaseModel):
    ...
    races: Optional[conlist(APIReference)] = Field(None, description="List of `Races` that have access to the trait.")
    subraces: Optional[conlist(APIReference)] = Field(None, description="List of `Subraces` that have access to the trait.")
    proficiencies: Optional[conlist(APIReference)] = Field(None, description="List of `Proficiencies` this trait grants.")
    proficiency_choices: Optional[Choice] = None
    language_options: Optional[Choice] = None
    trait_specific: Optional[TraitAllOfTraitSpecific] = None
    __properties = ["index", "name", "url", "desc", "races", "subraces", "proficiencies", "proficiency_choices", "language_options", "trait_specific"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Trait:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of proficiency_choices
        if self.proficiency_choices:
            _dict['proficiency_choices'] = self.proficiency_choices.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of trait_specific
        if self.trait_specific:
            _dict['trait_specific'] = self.trait_specific.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> Trait:
        """Create an instance of Trait from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Trait.parse_obj(obj)

        _obj = Trait.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "desc": obj.get("desc"),
            "races": [APIReference.from_dict(_item) for _item in obj.get("races")] if obj.get("races") is not None else None,
            ...
            "proficiency_choices": Choice.from_dict(obj.get("proficiency_choices")) if obj.get("proficiency_choices") is not None else None,
            "language_options": Choice.from_dict(obj.get("language_options")) if obj.get("language_options") is not None else None,
            "trait_specific": TraitAllOfTraitSpecific.from_dict(obj.get("trait_specific")) if obj.get("trait_specific") is not None else None
        })
        return _obj
