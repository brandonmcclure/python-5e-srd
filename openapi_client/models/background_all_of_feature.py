...
class BackgroundAllOfFeature(BaseModel):
    """
    Special feature granted to new characters of this background.
    """
    name: Optional[StrictStr] = None
    desc: Optional[conlist(StrictStr)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BackgroundAllOfFeature:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BackgroundAllOfFeature:
        """Create an instance of BackgroundAllOfFeature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BackgroundAllOfFeature.parse_obj(obj)

        _obj = BackgroundAllOfFeature.parse_obj({
            "name": obj.get("name"),
            "desc": obj.get("desc")
        })
        return _obj
