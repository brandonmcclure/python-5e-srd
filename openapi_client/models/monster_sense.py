...
class MonsterSense(BaseModel):
    """
    MonsterSense
    """
    passive_perception: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The monster's passive perception (wisdom) score.")
    blindsight: Optional[StrictStr] = Field(None, description="A monster with blindsight can perceive its surroundings without relying on sight, within a specific radius.")
    darkvision: Optional[StrictStr] = Field(None, description="A monster with darkvision can see in the dark within a specific radius.")
    tremorsense: Optional[StrictStr] = Field(None, description="A monster with tremorsense can detect and pinpoint the origin of vibrations within a specific radius, provided that the monster and the source of the vibrations are in contact with the same ground or substance.")
    truesight: Optional[StrictStr] = Field(None, description="A monster with truesight can, out to a specific range, see in normal and magical darkness, see invisible creatures and objects, automatically detect visual illusions and succeed on saving throws against them, and perceive the original form of a shapechanger or a creature that is transformed by magic. Furthermore, the monster can see into the Ethereal Plane within the same range.")
    __properties = ["passive_perception", "blindsight", "darkvision", "tremorsense", "truesight"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterSense:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterSense:
        """Create an instance of MonsterSense from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterSense.parse_obj(obj)

        _obj = MonsterSense.parse_obj({
            "passive_perception": obj.get("passive_perception"),
            "blindsight": obj.get("blindsight"),
            "darkvision": obj.get("darkvision"),
            "tremorsense": obj.get("tremorsense"),
            "truesight": obj.get("truesight")
        })
        return _obj
