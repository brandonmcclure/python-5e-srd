...
class WeaponProperty(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WeaponProperty:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WeaponProperty:
        """Create an instance of WeaponProperty from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WeaponProperty.parse_obj(obj)

        _obj = WeaponProperty.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "desc": obj.get("desc")
