...
class MonsterSpecialAbility(BaseModel):
    ...
    dc: Optional[DC] = None
    spellcasting: Optional[MonsterSpellcasting] = None
    usage: Optional[MonsterUsage] = None
    __properties = ["name", "desc", "attack_bonus", "damage", "dc", "spellcasting", "usage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterSpecialAbility:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterSpecialAbility:
        """Create an instance of MonsterSpecialAbility from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterSpecialAbility.parse_obj(obj)

        _obj = MonsterSpecialAbility.parse_obj({
            "name": obj.get("name"),
            "desc": obj.get("desc"),
            ...
            "spellcasting": MonsterSpellcasting.from_dict(obj.get("spellcasting")) if obj.get("spellcasting") is not None else None,
            "usage": MonsterUsage.from_dict(obj.get("usage")) if obj.get("usage") is not None else None
        })
        return _obj
