...
class Proficiency(BaseModel):
    ...
    type: Optional[StrictStr] = Field(None, description="The general category of the proficiency.")
    classes: Optional[conlist(APIReference)] = Field(None, description="Classes that start with this proficiency.")
    races: Optional[conlist(APIReference)] = Field(None, description="Races that start with this proficiency.")
    reference: Optional[APIReference] = None
    __properties = ["index", "name", "url", "type", "classes", "races", "reference"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Proficiency:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Proficiency:
        """Create an instance of Proficiency from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Proficiency.parse_obj(obj)

        _obj = Proficiency.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "type": obj.get("type"),
            ...
            "reference": APIReference.from_dict(obj.get("reference")) if obj.get("reference") is not None else None
        })
        return _obj
