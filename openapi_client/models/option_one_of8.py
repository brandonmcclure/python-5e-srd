...
class OptionOneOf8(BaseModel):
    ...
    bonus: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The bonus being applied to the ability score")
    __properties = ["option_type", "ability_score", "bonus"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OptionOneOf8:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OptionOneOf8:
        """Create an instance of OptionOneOf8 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OptionOneOf8.parse_obj(obj)

        _obj = OptionOneOf8.parse_obj({
