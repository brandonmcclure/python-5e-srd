...
class SpellPrerequisite(BaseModel):
    ...
    type: Optional[StrictStr] = Field(None, description="The type of prerequisite.")
    __properties = ["index", "name", "url", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpellPrerequisite:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpellPrerequisite:
        """Create an instance of SpellPrerequisite from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpellPrerequisite.parse_obj(obj)

        _obj = SpellPrerequisite.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "type": obj.get("type")
