...
class SubclassLevelSpellcasting(BaseModel):
    """
    Summary of spells known at this level.
    """
    cantrips_known: Optional[Union[StrictFloat, StrictInt]] = None
    spells_known: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_1: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_2: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_3: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_4: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_5: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_6: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_7: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_8: Optional[Union[StrictFloat, StrictInt]] = None
    spell_slots_level_9: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["cantrips_known", "spells_known", "spell_slots_level_1", "spell_slots_level_2", "spell_slots_level_3", "spell_slots_level_4", "spell_slots_level_5", "spell_slots_level_6", "spell_slots_level_7", "spell_slots_level_8", "spell_slots_level_9"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubclassLevelSpellcasting:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubclassLevelSpellcasting:
        """Create an instance of SubclassLevelSpellcasting from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubclassLevelSpellcasting.parse_obj(obj)

        _obj = SubclassLevelSpellcasting.parse_obj({
            "cantrips_known": obj.get("cantrips_known"),
            "spells_known": obj.get("spells_known"),
            "spell_slots_level_1": obj.get("spell_slots_level_1"),
            "spell_slots_level_2": obj.get("spell_slots_level_2"),
            "spell_slots_level_3": obj.get("spell_slots_level_3"),
            "spell_slots_level_4": obj.get("spell_slots_level_4"),
            "spell_slots_level_5": obj.get("spell_slots_level_5"),
            "spell_slots_level_6": obj.get("spell_slots_level_6"),
            "spell_slots_level_7": obj.get("spell_slots_level_7"),
            "spell_slots_level_8": obj.get("spell_slots_level_8"),
            "spell_slots_level_9": obj.get("spell_slots_level_9")
        })
        return _obj
