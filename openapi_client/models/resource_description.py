...
class ResourceDescription(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceDescription:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceDescription:
        """Create an instance of ResourceDescription from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceDescription.parse_obj(obj)

        _obj = ResourceDescription.parse_obj({
            "desc": obj.get("desc")
        })
        return _obj
