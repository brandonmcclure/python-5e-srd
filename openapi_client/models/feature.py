...
class Feature(BaseModel):
    ...
    level: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The level this feature is gained.")
    var_class: Optional[APIReference] = Field(None, alias="class")
    subclass: Optional[APIReference] = None
    parent: Optional[APIReference] = None
    prerequisites: Optional[conlist(FeatureAllOfPrerequisitesInner)] = Field(None, description="The prerequisites for this feature.")
    feature_specific: Optional[Dict[str, Any]] = Field(None, description="Information specific to this feature.")
    __properties = ["index", "name", "url", "desc", "level", "class", "subclass", "parent", "prerequisites", "feature_specific"]
    ...
    def from_dict(cls, obj: dict) -> Feature:
        ...
        _obj = Feature.parse_obj({
            ...
            "desc": obj.get("desc"),
            "level": obj.get("level"),
            "var_class": APIReference.from_dict(obj.get("class")) if obj.get("class") is not None else None,
            "subclass": APIReference.from_dict(obj.get("subclass")) if obj.get("subclass") is not None else None,
            "parent": APIReference.from_dict(obj.get("parent")) if obj.get("parent") is not None else None,
            "prerequisites": [FeatureAllOfPrerequisitesInner.from_dict(_item) for _item in obj.get("prerequisites")] if obj.get("prerequisites") is not None else None,
            "feature_specific": obj.get("feature_specific")
        })
        return _obj
