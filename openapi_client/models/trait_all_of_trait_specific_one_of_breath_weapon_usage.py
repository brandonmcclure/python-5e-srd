...
class TraitAllOfTraitSpecificOneOfBreathWeaponUsage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TraitAllOfTraitSpecificOneOfBreathWeaponUsage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TraitAllOfTraitSpecificOneOfBreathWeaponUsage:
        """Create an instance of TraitAllOfTraitSpecificOneOfBreathWeaponUsage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TraitAllOfTraitSpecificOneOfBreathWeaponUsage.parse_obj(obj)

        _obj = TraitAllOfTraitSpecificOneOfBreathWeaponUsage.parse_obj({
            "times": obj.get("times"),
            "type": obj.get("type")
        })
        return _obj
