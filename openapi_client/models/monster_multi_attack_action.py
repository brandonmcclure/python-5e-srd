...
class MonsterMultiAttackAction(BaseModel):
    """
    ...
    __properties = ["action_name", "count", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterMultiAttackAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterMultiAttackAction:
        """Create an instance of MonsterMultiAttackAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterMultiAttackAction.parse_obj(obj)

        _obj = MonsterMultiAttackAction.parse_obj({
