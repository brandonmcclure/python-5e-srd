...
class DamageAtSlotLevel(BaseModel):
    ...
    __properties = ["damage_at_slot_level", "damage_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DamageAtSlotLevel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DamageAtSlotLevel:
        """Create an instance of DamageAtSlotLevel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DamageAtSlotLevel.parse_obj(obj)

        _obj = DamageAtSlotLevel.parse_obj({
            "damage_at_slot_level": obj.get("damage_at_slot_level"),
