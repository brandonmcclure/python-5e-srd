...
class Armor(BaseModel):
    ...
    armor_category: Optional[StrictStr] = Field(None, description="The category of armor this falls into.")
    armor_class: Optional[Dict[str, StrictStr]] = Field(None, description="Details on how to calculate armor class.")
    str_minimum: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="Minimum STR required to use this armor.")
    stealth_disadvantage: Optional[StrictBool] = Field(None, description="Whether the armor gives disadvantage for Stealth.")
    cost: Optional[Cost] = None
    weight: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="How much the equipment weighs.")
    __properties = ["index", "name", "url", "desc", "equipment_category", "armor_category", "armor_class", "str_minimum", "stealth_disadvantage", "cost", "weight"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Armor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Armor:
        """Create an instance of Armor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Armor.parse_obj(obj)

        _obj = Armor.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "desc": obj.get("desc"),
            "equipment_category": APIReference.from_dict(obj.get("equipment_category")) if obj.get("equipment_category") is not None else None,
            "armor_category": obj.get("armor_category"),
            "armor_class": obj.get("armor_class"),
            "str_minimum": obj.get("str_minimum"),
            "stealth_disadvantage": obj.get("stealth_disadvantage"),
