...
class MonsterArmorClassOneOf(BaseModel):
    """
    MonsterArmorClassOneOf
    """
    type: Optional[StrictStr] = None
    value: Optional[Union[StrictFloat, StrictInt]] = None
    desc: Optional[StrictStr] = None
    __properties = ["type", "value", "desc"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('dex', 'natural', 'armor', 'spell', 'condition'):
            raise ValueError("must be one of enum values ('dex', 'natural', 'armor', 'spell', 'condition')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MonsterArmorClassOneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MonsterArmorClassOneOf:
        """Create an instance of MonsterArmorClassOneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MonsterArmorClassOneOf.parse_obj(obj)

        _obj = MonsterArmorClassOneOf.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
            "desc": obj.get("desc")
        })
