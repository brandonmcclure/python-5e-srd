...
class Weapon(BaseModel):
    ...
    weapon_category: Optional[StrictStr] = Field(None, description="The category of weapon this falls into.")
    weapon_range: Optional[StrictStr] = Field(None, description="Whether this is a Melee or Ranged weapon.")
    category_range: Optional[StrictStr] = Field(None, description="A combination of weapon_category and weapon_range.")
    range: Optional[WeaponAllOfRange] = None
    damage: Optional[Damage] = None
    two_handed_damage: Optional[Damage] = None
    properties: Optional[conlist(APIReference)] = Field(None, description="A list of the properties this weapon has.")
    cost: Optional[Cost] = None
    weight: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="How much the equipment weighs.")
    __properties = ["index", "name", "url", "desc", "equipment_category", "weapon_category", "weapon_range", "category_range", "range", "damage", "two_handed_damage", "properties", "cost", "weight"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Weapon:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of equipment_category
        if self.equipment_category:
            _dict['equipment_category'] = self.equipment_category.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of two_handed_damage
        if self.two_handed_damage:
            _dict['two_handed_damage'] = self.two_handed_damage.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Weapon:
        """Create an instance of Weapon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Weapon.parse_obj(obj)

        _obj = Weapon.parse_obj({
            "index": obj.get("index"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "desc": obj.get("desc"),
            "equipment_category": APIReference.from_dict(obj.get("equipment_category")) if obj.get("equipment_category") is not None else None,
            "weapon_category": obj.get("weapon_category"),
            "weapon_range": obj.get("weapon_range"),
            "category_range": obj.get("category_range"),
            "range": WeaponAllOfRange.from_dict(obj.get("range")) if obj.get("range") is not None else None,
            "damage": Damage.from_dict(obj.get("damage")) if obj.get("damage") is not None else None,
            "two_handed_damage": Damage.from_dict(obj.get("two_handed_damage")) if obj.get("two_handed_damage") is not None else None,
            "properties": [APIReference.from_dict(_item) for _item in obj.get("properties")] if obj.get("properties") is not None else None,
