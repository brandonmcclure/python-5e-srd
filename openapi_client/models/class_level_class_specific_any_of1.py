...
class ClassLevelClassSpecificAnyOf1(BaseModel):
    """
    Bard Class Specific Features
    """
    bardic_inspiration_dice: Optional[Union[StrictFloat, StrictInt]] = None
    song_of_rest_die: Optional[Union[StrictFloat, StrictInt]] = None
    magical_secrets_max_5: Optional[Union[StrictFloat, StrictInt]] = None
    magical_secrets_max_7: Optional[Union[StrictFloat, StrictInt]] = None
    magical_secrets_max_9: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["bardic_inspiration_dice", "song_of_rest_die", "magical_secrets_max_5", "magical_secrets_max_7", "magical_secrets_max_9"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf1:
        """Create an instance of ClassLevelClassSpecificAnyOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf1.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf1.parse_obj({
            "bardic_inspiration_dice": obj.get("bardic_inspiration_dice"),
            "song_of_rest_die": obj.get("song_of_rest_die"),
            "magical_secrets_max_5": obj.get("magical_secrets_max_5"),
            "magical_secrets_max_7": obj.get("magical_secrets_max_7"),
            "magical_secrets_max_9": obj.get("magical_secrets_max_9")
        })
        return _obj
