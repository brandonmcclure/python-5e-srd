...
class ClassLevelClassSpecificAnyOf6(BaseModel):
    """
    Paladin Class Specific Features
    """
    aura_range: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["aura_range"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf6:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf6:
        """Create an instance of ClassLevelClassSpecificAnyOf6 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf6.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf6.parse_obj({
            "aura_range": obj.get("aura_range")
        })
        return _obj
