...
class ClassLevelClassSpecificAnyOf3(BaseModel):
    """
    Druid Class Specific Features
    """
    wild_shape_max_cr: Optional[Union[StrictFloat, StrictInt]] = None
    wild_shape_swim: Optional[StrictBool] = None
    wild_shape_fly: Optional[StrictBool] = None
    __properties = ["wild_shape_max_cr", "wild_shape_swim", "wild_shape_fly"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassLevelClassSpecificAnyOf3:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassLevelClassSpecificAnyOf3:
        """Create an instance of ClassLevelClassSpecificAnyOf3 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClassLevelClassSpecificAnyOf3.parse_obj(obj)

        _obj = ClassLevelClassSpecificAnyOf3.parse_obj({
            "wild_shape_max_cr": obj.get("wild_shape_max_cr"),
            "wild_shape_swim": obj.get("wild_shape_swim"),
            "wild_shape_fly": obj.get("wild_shape_fly")
        })
        return _obj
