...
class OptionOneOf10(BaseModel):
    ...
    damage_dice: Optional[StrictStr] = Field(None, description="Damage expressed in dice (e.g. \"13d6\").")
    notes: Optional[StrictStr] = Field(None, description="Information regarding the damage.")
    __properties = ["option_type", "damage_type", "damage_dice", "notes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OptionOneOf10:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OptionOneOf10:
        """Create an instance of OptionOneOf10 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OptionOneOf10.parse_obj(obj)

        _obj = OptionOneOf10.parse_obj({
            "option_type": obj.get("option_type"),
            "damage_type": APIReference.from_dict(obj.get("damage_type")) if obj.get("damage_type") is not None else None,
            "damage_dice": obj.get("damage_dice"),
            "notes": obj.get("notes")
        })
        return _obj
