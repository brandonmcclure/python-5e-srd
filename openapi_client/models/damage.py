...
class Damage(BaseModel):
    ...
    __properties = ["damage_dice", "damage_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Damage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Damage:
        """Create an instance of Damage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Damage.parse_obj(obj)

        _obj = Damage.parse_obj({
