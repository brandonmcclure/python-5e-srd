...
class EquipmentApi(object):
    ...
    @validate_arguments
    def api_equipment_categories_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the equipment category score to get.  Available values can be found in the resource list for this endpoint. ")], **kwargs) -> EquipmentCategory:  # noqa: E501
        """Get an equipment category by index.  # noqa: E501

        These are the categories that various equipment fall under.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_equipment_categories_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the equipment category score to get.  Available values can be found in the resource list for this endpoint.  (required)
        :type index: str
        ...
        :rtype: EquipmentCategory
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_equipment_categories_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_equipment_categories_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_equipment_categories_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the equipment category score to get.  Available values can be found in the resource list for this endpoint. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get an equipment category by index.  # noqa: E501
        ...
        >>> thread = api.api_equipment_categories_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(EquipmentCategory, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_equipment_categories_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/equipment-categories/{index}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def api_equipment_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the equipment to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `equipment`. ")], **kwargs) -> Equipment:  # noqa: E501
        """Get an equipment item by index.  # noqa: E501

        # Equipment  Opportunities abound to find treasure, equipment, weapons, armor, and more  in the dungeons you explore. Normally, you can sell your treasures and  trinkets when you return to a town or other settlement, provided that you  can find buyers and merchants interested in your loot.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_equipment_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the equipment to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `equipment`.  (required)
        :type index: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_equipment_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_equipment_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_equipment_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the equipment to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `equipment`. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get an equipment item by index.  # noqa: E501
        ...
        >>> thread = api.api_equipment_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Equipment, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_equipment_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_magic_items_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the magic item to get.  Available values can be found in the resource list for this endpoint. ")], **kwargs) -> MagicItem:  # noqa: E501
        """Get a magic item by index.  # noqa: E501

        These are the various magic items you can find in the game.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_magic_items_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the magic item to get.  Available values can be found in the resource list for this endpoint.  (required)
        :type index: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_magic_items_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_magic_items_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_magic_items_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the magic item to get.  Available values can be found in the resource list for this endpoint. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a magic item by index.  # noqa: E501
        ...
        >>> thread = api.api_magic_items_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MagicItem, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_magic_items_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_weapon_properties_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the weapon property to get. ")], **kwargs) -> WeaponProperty:  # noqa: E501
        """Get a weapon property by index.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_weapon_properties_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the weapon property to get.  (required)
        :type index: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: WeaponProperty
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_weapon_properties_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_weapon_properties_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_weapon_properties_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the weapon property to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a weapon property by index.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_weapon_properties_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(WeaponProperty, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_weapon_properties_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/weapon-properties/{index}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
