...
class CommonApi(object):
    ...
    @validate_arguments
    def api_endpoint_get(self, endpoint : StrictStr, **kwargs) -> APIReferenceList:  # noqa: E501
        """Get list of all available resources for an endpoint.  # noqa: E501

        Currently only the [`/spells`](#get-/api/spells) and [`/monsters`](#get-/api/monsters) endpoints support filtering with query parameters. Use of these query parameters is documented under the respective [Spells](#tag--Spells) and [Monsters](#tag--Monsters) sections.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_endpoint_get(endpoint, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_endpoint_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_endpoint_get_with_http_info(endpoint, **kwargs)  # noqa: E501

    @validate_arguments
    def api_endpoint_get_with_http_info(self, endpoint : StrictStr, **kwargs) -> ApiResponse:  # noqa: E501
        """Get list of all available resources for an endpoint.  # noqa: E501
        ...
        >>> thread = api.api_endpoint_get_with_http_info(endpoint, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_endpoint_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_get(self, **kwargs) -> Dict[str, str]:  # noqa: E501
        """Get all resource URLs.  # noqa: E501

        Making a request to the API's base URL returns an object containing available endpoints.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_get_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def api_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get all resource URLs.  # noqa: E501
        ...
        >>> thread = api.api_get_with_http_info(async_req=True)
        >>> result = thread.get()
