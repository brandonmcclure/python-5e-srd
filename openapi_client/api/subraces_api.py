...
class SubracesApi(object):
    ...
    @validate_arguments
    def api_subraces_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the subrace to get. ")], **kwargs) -> Subrace:  # noqa: E501
        """Get a subrace by index.  # noqa: E501

        Subraces reflect the different varieties of a certain parent race.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_subraces_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the subrace to get.  (required)
        :type index: str
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_subraces_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_subraces_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_subraces_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the subrace to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a subrace by index.  # noqa: E501
        ...
        >>> thread = api.api_subraces_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Subrace, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_subraces_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_subraces_index_proficiencies_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the subrace to get. ")], **kwargs) -> APIReferenceList:  # noqa: E501
        """Get proficiences available for a subrace.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_subraces_index_proficiencies_get(index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_subraces_index_proficiencies_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_subraces_index_proficiencies_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_subraces_index_proficiencies_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the subrace to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get proficiences available for a subrace.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_subraces_index_proficiencies_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_subraces_index_proficiencies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/subraces/{index}/proficiencies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def api_subraces_index_traits_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the subrace to get. ")], **kwargs) -> APIReferenceList:  # noqa: E501
        """Get traits available for a subrace.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_subraces_index_traits_get(index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_subraces_index_traits_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_subraces_index_traits_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_subraces_index_traits_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the subrace to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get traits available for a subrace.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_subraces_index_traits_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_subraces_index_traits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
