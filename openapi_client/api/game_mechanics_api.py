...
class GameMechanicsApi(object):
    ...
    @validate_arguments
    def api_conditions_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the condition to get. ")], **kwargs) -> Condition:  # noqa: E501
        """Get a condition by index.  # noqa: E501

        # Condition  A condition alters a creature’s capabilities in a variety of ways and can  arise as a result of a spell, a class feature, a monster’s attack, or other  effect. Most conditions, such as blinded, are impairments, but a few, such  as invisible, can be advantageous.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_conditions_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the condition to get.  (required)
        :type index: str
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_conditions_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_conditions_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_conditions_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the condition to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a condition by index.  # noqa: E501
        ...
        >>> thread = api.api_conditions_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Condition, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_conditions_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_damage_types_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the damage type to get. ")], **kwargs) -> DamageType:  # noqa: E501
        """Get a damage type by index.  # noqa: E501

        # Damage type  Different attacks, damaging spells, and other harmful effects deal different  types of damage. Damage types have no rules of their own, but other rules,  such as damage resistance, rely on the types.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_damage_types_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the damage type to get.  (required)
        :type index: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_damage_types_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_damage_types_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_damage_types_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the damage type to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a damage type by index.  # noqa: E501
        ...
        >>> thread = api.api_damage_types_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(DamageType, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_damage_types_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_magic_schools_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the magic school to get. ")], **kwargs) -> MagicSchool:  # noqa: E501
        """Get a magic school by index.  # noqa: E501

        # Magic School  Academies of magic group spells into eight categories called schools of  magic. Scholars, particularly wizards, apply these categories to all spells,  believing that all magic functions in essentially the same way, whether it  derives from rigorous study or is bestowed by a deity.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_magic_schools_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the magic school to get.  (required)
        :type index: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_magic_schools_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_magic_schools_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_magic_schools_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the magic school to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a magic school by index.  # noqa: E501
        ...
        >>> thread = api.api_magic_schools_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MagicSchool, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_magic_schools_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
