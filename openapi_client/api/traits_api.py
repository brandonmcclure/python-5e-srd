...
class TraitsApi(object):
    ...
    @validate_arguments
    def api_traits_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the `Trait` to get.")], **kwargs) -> Trait:  # noqa: E501
        """Get a trait by index.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_traits_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the `Trait` to get. (required)
        :type index: str
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_traits_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_traits_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_traits_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the `Trait` to get.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a trait by index.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_traits_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Trait, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_traits_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
