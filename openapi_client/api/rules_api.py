...
class RulesApi(object):
    ...
    @validate_arguments
    def api_rule_sections_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the rule section to get. ")], **kwargs) -> RuleSection:  # noqa: E501
        """Get a rule section by index.  # noqa: E501

        Rule sections represent a sub-heading and text that can be found underneath a rule heading in the SRD.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_rule_sections_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the rule section to get.  (required)
        :type index: str
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_rule_sections_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_rule_sections_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_rule_sections_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the rule section to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a rule section by index.  # noqa: E501
        ...
        >>> thread = api.api_rule_sections_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(RuleSection, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_rule_sections_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_rules_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the rule to get. ")], **kwargs) -> Rule:  # noqa: E501
        """Get a rule by index.  # noqa: E501

        # Rule   Rules are pages in the SRD that document the mechanics of Dungeons and Dragons.  Rules have descriptions which is the text directly underneath the rule heading  in the SRD. Rules also have subsections for each heading underneath the rule in the SRD.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_rules_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the rule to get.  (required)
        :type index: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_rules_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_rules_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_rules_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the rule to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a rule by index.  # noqa: E501
        ...
        >>> thread = api.api_rules_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_rules_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
