...
class ClassLevelsApi(object):
    ...
    @validate_arguments
    def api_classes_index_levels_class_level_features_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], class_level : Union[confloat(le=20, ge=0, strict=True), conint(le=20.0, ge=0.0, strict=True)], **kwargs) -> APIReferenceList:  # noqa: E501
        """Get features available to a class at the requested level.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_levels_class_level_features_get(index, class_level, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the class to get.  (required)
        :type index: str
        :param class_level: (required)
        :type class_level: float
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_classes_index_levels_class_level_features_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_classes_index_levels_class_level_features_get_with_http_info(index, class_level, **kwargs)  # noqa: E501

    @validate_arguments
    def api_classes_index_levels_class_level_features_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], class_level : Union[confloat(le=20, ge=0, strict=True), conint(le=20.0, ge=0.0, strict=True)], **kwargs) -> ApiResponse:  # noqa: E501
        """Get features available to a class at the requested level.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_levels_class_level_features_get_with_http_info(index, class_level, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_classes_index_levels_class_level_features_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['class_level']:
            _path_params['class_level'] = _params['class_level']
        ...
        return self.api_client.call_api(
            '/api/classes/{index}/levels/{class_level}/features', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def api_classes_index_levels_class_level_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], class_level : Union[confloat(le=20, ge=0, strict=True), conint(le=20.0, ge=0.0, strict=True)], **kwargs) -> ClassLevel:  # noqa: E501
        """Get level resource for a class and level.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_levels_class_level_get(index, class_level, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_classes_index_levels_class_level_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_classes_index_levels_class_level_get_with_http_info(index, class_level, **kwargs)  # noqa: E501

    @validate_arguments
    def api_classes_index_levels_class_level_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], class_level : Union[confloat(le=20, ge=0, strict=True), conint(le=20.0, ge=0.0, strict=True)], **kwargs) -> ApiResponse:  # noqa: E501
        """Get level resource for a class and level.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_levels_class_level_get_with_http_info(index, class_level, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ClassLevel, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_classes_index_levels_class_level_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/classes/{index}/levels/{class_level}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def api_classes_index_levels_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], subclass : Annotated[Optional[StrictStr], Field(description="Adds subclasses for class to the response")] = None, **kwargs) -> List[ClassLevel]:  # noqa: E501
        """Get all level resources for a class.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_levels_get(index, subclass, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: List[ClassLevel]
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_classes_index_levels_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_classes_index_levels_get_with_http_info(index, subclass, **kwargs)  # noqa: E501

    @validate_arguments
    def api_classes_index_levels_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], subclass : Annotated[Optional[StrictStr], Field(description="Adds subclasses for class to the response")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get all level resources for a class.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_levels_get_with_http_info(index, subclass, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[ClassLevel], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_classes_index_levels_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the query parameters
        _query_params = []
        if _params.get('subclass') is not None:  # noqa: E501
            _query_params.append(('subclass', _params['subclass']))
    ...
    @validate_arguments
    def api_classes_index_levels_spell_level_spells_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], spell_level : Union[confloat(le=9, ge=1, strict=True), conint(le=9.0, ge=1.0, strict=True)], **kwargs) -> APIReferenceList:  # noqa: E501
        """Get spells of the requested level available to the class.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_levels_spell_level_spells_get(index, spell_level, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the class to get.  (required)
        :type index: str
        :param spell_level: (required)
        :type spell_level: float
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_classes_index_levels_spell_level_spells_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_classes_index_levels_spell_level_spells_get_with_http_info(index, spell_level, **kwargs)  # noqa: E501

    @validate_arguments
    def api_classes_index_levels_spell_level_spells_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], spell_level : Union[confloat(le=9, ge=1, strict=True), conint(le=9.0, ge=1.0, strict=True)], **kwargs) -> ApiResponse:  # noqa: E501
        """Get spells of the requested level available to the class.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_levels_spell_level_spells_get_with_http_info(index, spell_level, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_classes_index_levels_spell_level_spells_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['spell_level']:
            _path_params['spell_level'] = _params['spell_level']
        ...
        return self.api_client.call_api(
            '/api/classes/{index}/levels/{spell_level}/spells', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
