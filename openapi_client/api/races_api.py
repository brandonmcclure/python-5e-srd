...
class RacesApi(object):
    ...
    @validate_arguments
    def api_races_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the race to get. ")], **kwargs) -> Race:  # noqa: E501
        """Get a race by index.  # noqa: E501

        Each race grants your character ability and skill bonuses as well as racial traits.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_races_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the race to get.  (required)
        :type index: str
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_races_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_races_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_races_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the race to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a race by index.  # noqa: E501
        ...
        >>> thread = api.api_races_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Race, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_races_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_races_index_proficiencies_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the race to get. ")], **kwargs) -> APIReferenceList:  # noqa: E501
        """Get proficiencies available for a race.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_races_index_proficiencies_get(index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_races_index_proficiencies_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_races_index_proficiencies_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_races_index_proficiencies_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the race to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get proficiencies available for a race.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_races_index_proficiencies_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_races_index_proficiencies_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/races/{index}/proficiencies', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def api_races_index_subraces_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the race to get. ")], **kwargs) -> APIReferenceList:  # noqa: E501
        """Get subraces available for a race.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_races_index_subraces_get(index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_races_index_subraces_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_races_index_subraces_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_races_index_subraces_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the race to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get subraces available for a race.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_races_index_subraces_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_races_index_subraces_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_races_index_traits_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the race to get. ")], **kwargs) -> APIReferenceList:  # noqa: E501
        """Get traits available for a race.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_races_index_traits_get(index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_races_index_traits_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_races_index_traits_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_races_index_traits_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the race to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get traits available for a race.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_races_index_traits_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_races_index_traits_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
