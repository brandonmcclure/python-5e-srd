...
class SpellsApi(object):
    ...
    @validate_arguments
    def api_spells_get(self, level : Annotated[Optional[conlist(StrictInt)], Field(description="The level or levels to filter on.")] = None, school : Annotated[Optional[conlist(StrictStr)], Field(description="The magic school or schools to filter on.")] = None, **kwargs) -> APIReferenceList:  # noqa: E501
        """Get list of spells with optional filtering.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_spells_get(level, school, async_req=True)
        >>> result = thread.get()

        :param level: The level or levels to filter on.
        :type level: List[int]
        :param school: The magic school or schools to filter on.
        :type school: List[str]
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_spells_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_spells_get_with_http_info(level, school, **kwargs)  # noqa: E501

    @validate_arguments
    def api_spells_get_with_http_info(self, level : Annotated[Optional[conlist(StrictInt)], Field(description="The level or levels to filter on.")] = None, school : Annotated[Optional[conlist(StrictStr)], Field(description="The magic school or schools to filter on.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get list of spells with optional filtering.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_spells_get_with_http_info(level, school, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def api_spells_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the `Spell` to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `spells`. ")], **kwargs) -> Spell:  # noqa: E501
        """Get a spell by index.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_spells_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the `Spell` to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `spells`.  (required)
        :type index: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_spells_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_spells_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_spells_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the `Spell` to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `spells`. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a spell by index.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_spells_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Spell, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_spells_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
