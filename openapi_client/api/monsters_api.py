...
class MonstersApi(object):
    ...
    @validate_arguments
    def api_monsters_get(self, challenge_rating : Annotated[Optional[conlist(Union[StrictFloat, StrictInt])], Field(description="The challenge rating or ratings to filter on.")] = None, **kwargs) -> APIReferenceList:  # noqa: E501
        """Get list of monsters with optional filtering  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_monsters_get(challenge_rating, async_req=True)
        >>> result = thread.get()

        :param challenge_rating: The challenge rating or ratings to filter on.
        :type challenge_rating: List[float]
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_monsters_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_monsters_get_with_http_info(challenge_rating, **kwargs)  # noqa: E501

    @validate_arguments
    def api_monsters_get_with_http_info(self, challenge_rating : Annotated[Optional[conlist(Union[StrictFloat, StrictInt])], Field(description="The challenge rating or ratings to filter on.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get list of monsters with optional filtering  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_monsters_get_with_http_info(challenge_rating, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_monsters_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _query_params = []
        if _params.get('challenge_rating') is not None:  # noqa: E501
            _query_params.append(('challenge_rating', _params['challenge_rating']))
            _collection_formats['challenge_rating'] = 'multi'
    ...
    @validate_arguments
    def api_monsters_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the `Monster` to get. ")], **kwargs) -> Monster:  # noqa: E501
        """Get monster by index.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_monsters_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the `Monster` to get.  (required)
        :type index: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request. If one
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_monsters_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_monsters_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_monsters_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the `Monster` to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get monster by index.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_monsters_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Monster, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_monsters_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
