...
class ClassApi(object):
    ...
    @validate_arguments
    def api_classes_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], **kwargs) -> ModelClass:  # noqa: E501
        """Get a class by index.  # noqa: E501

        # Class  A character class is a fundamental part of the identity and nature of characters in the Dungeons & Dragons role-playing game. A character's capabilities, strengths, and weaknesses are largely defined by its class. A character's class affects a character's available skills and abilities. [[SRD p8-55](https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf#page=8)]   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_get(index, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_classes_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_classes_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_classes_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a class by index.  # noqa: E501
        ...
        >>> thread = api.api_classes_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_classes_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def api_classes_index_multi_classing_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], **kwargs) -> Multiclassing:  # noqa: E501
        """Get multiclassing resource for a class.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_multi_classing_get(index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_classes_index_multi_classing_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_classes_index_multi_classing_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_classes_index_multi_classing_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get multiclassing resource for a class.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_multi_classing_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Multiclassing, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_classes_index_multi_classing_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/classes/{index}/multi-classing', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def api_classes_index_spellcasting_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], **kwargs) -> Spellcasting:  # noqa: E501
        """Get spellcasting info for a class.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_spellcasting_get(index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_classes_index_spellcasting_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_classes_index_spellcasting_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_classes_index_spellcasting_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the class to get. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get spellcasting info for a class.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_classes_index_spellcasting_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Spellcasting, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_classes_index_spellcasting_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/api/classes/{index}/spellcasting', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
