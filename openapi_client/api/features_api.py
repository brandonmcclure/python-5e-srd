...
class FeaturesApi(object):
    ...
    @validate_arguments
    def api_features_index_get(self, index : Annotated[StrictStr, Field(..., description="The `index` of the feature to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `features`. ")], **kwargs) -> Feature:  # noqa: E501
        """Get a feature by index.  # noqa: E501

        # Feature   When you gain a new level in a class, you get its features for that level.  You don’t, however, receive the class’s starting Equipment, and a few  features have additional rules when you’re multiclassing: Channel Divinity,  Extra Attack, Unarmored Defense, and Spellcasting.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.api_features_index_get(index, async_req=True)
        >>> result = thread.get()

        :param index: The `index` of the feature to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `features`.  (required)
        :type index: str
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the api_features_index_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.api_features_index_get_with_http_info(index, **kwargs)  # noqa: E501

    @validate_arguments
    def api_features_index_get_with_http_info(self, index : Annotated[StrictStr, Field(..., description="The `index` of the feature to get.  Available values can be found in the [`ResourceList`](#get-/api/-endpoint-) for `features`. ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a feature by index.  # noqa: E501
        ...
        >>> thread = api.api_features_index_get_with_http_info(index, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Feature, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method api_features_index_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
